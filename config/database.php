    ...
    */
    ...
    'connections' => [
        ...
        'mysql_mundimed_v1' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', '162.240.170.186'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'wwmund_mundimed'),
            'username' => env('DB_USERNAME', 'wwmund_admin'),
            'password' => env('DB_PASSWORD', 'Mundimed@2024'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'mysql_mundimed_credenciados' => [
            ...
            'password' => env('DB_PASSWORD', 'Cox@2024'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
